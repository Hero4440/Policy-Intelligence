...
export function Sidebar({
  ...
  useEffect(() => {
    ...
    debounceRef.current = setTimeout(() => {
      void fetch(`/api/antonrx/drugs?query=${encodeURIComponent(localInput.trim())}`)
  ...
  return (
    <aside className="sidebar">
      <div className="sidebar-section">
        <p className="eyebrow">Anton Rx Track</p>
      ...
      <div className="sidebar-section" ref={wrapperRef}>
      ...
      <div className="sidebar-section sidebar-note">
        <span className="note-badge">Data</span>
        <p>
          Final insurance data package drives plan breadth. Upload and source visualization now live in the main center pane.
        </p>
      </div>
    </aside>
  );
